    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Enter your Login ID (e.g. admin01)"
        ...
        <button
          type="submit"
          disabled={loading}
          className="h-14 w-full rounded-xl bg-[#6B705C] text-base font-semibold text-white shadow-sm transition hover:bg-[#59604E] focus:outline-none focus:ring-4 focus:ring-[#6B705C]/20 active:scale-[0.99] disabled:opacity-50"
        >
...
function LockIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
      ...
      <path d="M8 10V7C8 4.79 9.79 3 12 3C14.21 3 16 4.79 16 7V10" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  );
}
