...
export default function Sidebar() {
  ...
  /*
    BACKEND INTEGRATION:
    const { user } = useAuth();
    // Replace hardcoded "Admin User" / "Administrator" below with `user?.name` and `user?.role`
  */
    ...
    <aside className="w-56 min-h-screen bg-[#F8F6F1] border-r border-[#E5E3DC] flex flex-col fixed left-0 top-0 bottom-0 z-50">
      ...
      <div className="border-t border-[#E5E3DC] px-4 py-3.5 bg-white/50">
        <div className="flex items-center gap-3">
          ...
          <Link href="/login" className="text-[#A5A58D] hover:text-[#C0392B] transition-colors p-1" title="Sign out">
